...
//////////
        pinMode(STEPPERS_DISABLE_PIN_Y, OUTPUT);  // global motor enable pin
        pinMode(STEPPERS_DISABLE_PIN_Z, OUTPUT);  // global motor enable pin
        pinMode(STEPPERS_DISABLE_PIN_A, OUTPUT);  // global motor enable pin
...
digitalWrite(STEPPERS_DISABLE_PIN_Y, disable);
digitalWrite(STEPPERS_DISABLE_PIN_Z, disable);
digitalWrite(STEPPERS_DISABLE_PIN_A, disable);
